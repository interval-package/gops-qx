...
def create_sampler(env_options: Union[dict, List[dict]]=None, **kwargs) -> object:
    ...
    if trainer_name is None or trainer_name.startswith("off_serial") or trainer_name.startswith("on_serial"):
        ...
        sam = [
            ray.remote(num_cpus=1)(sampler_creator).remote(index=idx, env_options=env_options, **_kwargs)
