...
class BaseSampler(metaclass=ABCMeta):
    def __init__(
        ...
        **kwargs
        ...
        self.obs, self.info = self.env.reset(options=env_options)
        if self._is_vector:
    ...
    def _step(self) -> List[Experience]:
        ...
        if self._is_vector:
            ...
            # print(f"Function env.step took {elapsed_time:.4f} seconds to complete.")
            ...
            next_obs, reward, done, truncated, next_info = self.env.step(action_clip)
