...
# policy = "../results/pyth_idsim/DSACTPI_240906-114753"
# policy = "/root/qianxing/gops-grpc/results/pyth_idsim/DSACTPI_240911-152639"
policy = "/root/qianxing/gops-grpc/results/pyth_idsim/DSACTPI_240915-194552"
# policy = "../results/pyth_idsim/DSACTPI_240911-214855"
model = "500000"
...
qianxing_config["render_ret"].update(run_config)
...
if "path" in qianxing_config["render_ret"].keys():
    path = qianxing_config["render_ret"]["path"]
    print(qianxing_config["render_ret"])
